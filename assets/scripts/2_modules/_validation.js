...
(function () {
  document.forms.contact.noValidate = true; // Disable HTML5 validation - using JavaScript instead
  // -------------------------------------------------------------------------
  ...
  function validateTypes(el) {
    ...
    var type = $(el).data('type') || el.getAttribute('id');  // OR get the type of input
  ...
  function showErrorMessage(el) {
    ...
    var errorContainer = $el.next('.error.message'); // Any siblings holding an error message
  ...
  function removeErrorMessage(el) {
    var errorContainer = $(el).next('.error.message'); // Get the sibling of this form control used to hold the error message
